...
Para correr el programa, debe de crearse un archivo llamado SecretConfig.py en la raiz del programa, en donde debera agregar la siguiente informacion obtenida de su base de datos creada en neon.tech:
